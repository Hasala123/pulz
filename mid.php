      ...
      <div class="container text-center">
        <div class="row">
          ...
          <div class="col-md-5 ml-auto mr-auto download-area">
            <a href="http://www.creative-tim.com/product/pulz-2" class="btn btn-danger btn-round">Download free HTML</a>
          </div>
        </div>
        <div class="row text-center upgrade-pro">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <p class="description">We've just launched
              <a href="http://demos.creative-tim.com/pulz-2-pro/presentation.html?ref=utp-pk2-demos" class="text-danger" target="_blank">Paper Kit 2 PRO</a>. It has a huge number of components, sections and example pages.</p>
          </div>
          <div class="col-sm-5 ml-auto mr-auto">
            <a href="https://www.creative-tim.com/product/pulz-2-pro?ref=utp-pk-demos" class="btn btn-info btn-round" target="_blank">
        ...
        <div class="row justify-content-md-center sharing-area text-center">
          ...
          <div class="text-center col-md-12 col-lg-8">
            ...
            <a href="https://github.com/creativetimofficial/pulz" class="btn btn-github-bg btn-github sharrre btn-round" rel="tooltip" title="Star on Github">
